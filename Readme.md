...
* If you get an error: ```Cannot start Bokeh server, port 5098 is already in use```, then at the terminal issue: 
  ...
  * You should see a line similar to the one below on the terminal:
   ```55525 12519 11678   0  1:22AM ttys004    0:57.81 /opt/anaconda3/bin/python /opt/anaconda3/bin/bokeh serve --port 5098 --show image_tSNE_GUI``` where the 2nd term is the process id. 
